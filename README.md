...
- `notebooks/`: Jupyter Notebooks und Python-Skripte für die Implementierung
  ...
  - `05_car_detection_on_images.py`: Autoerkennung auf Bildern
  - `06_bonus_person_detection.py`: Bonus-Aufgabe zur Personenerkennung
- `data/`: Cifar Datensatz und Labels
- `models/`: Trainierte Modelle und Visualisierungen
- `images/`: Testbilder für die Autoerkennung
- `results/`: Ergebnisse der Autoerkennung
...
2. Training des CNN mit Keras/TensorFlow:
   ...
   ```
3. Implementierung meines benutzerdefinierten CNN mit Implementierung aller benötigten Operationen:
   ```
